...
class Author(models.Model):
    ...
    def clean(self):
        """
        Validates that an author with the same name, surname, and patronymic does not already exist.
        Raises ValidationError if a duplicate is found (excluding the current instance during update).
        """
        ...
        if duplicate.exists():
            raise ValidationError(
                "Author with these name, surname and patronymic already exists."
            )
